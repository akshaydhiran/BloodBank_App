...
import com.akshay.bloodbank.Utils.Endpoints;
import com.akshay.bloodbank.Utils.VolleySingleton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                String name, city, blood_group, password, mobile_number;
                name = nameEt.getText().toString();
                city = cityEt.getText().toString();
                blood_group = bloodGroupEt.getText().toString();
                password = passwordEt.getText().toString();
                mobile_number = mobileEt.getText().toString();
                if (isValid(name, city, blood_group, password, mobile_number)) {
                    register(name, city, blood_group, password, mobile_number);
                }
            }
        });
